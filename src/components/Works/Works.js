    ...
    return (
        ...
        <WorkWrapperContainer id="works">
            <WorkWrapper>
                ...
                <WorkDiv>
                    <WorkItens title="Blog FullStack" techs="React, SASS, Node, MYSQL" subtitle="Um blog com sistema de likes e sessão de comentários integrado,onde é necessário criar uma conta e logar para prosseguir e conseguir interagir com o site. Crie, atualize, delete e comente." path="https://fullstackblogpedro.vercel.app/"  background={ImagesExports.NodeProject}></WorkItens>
